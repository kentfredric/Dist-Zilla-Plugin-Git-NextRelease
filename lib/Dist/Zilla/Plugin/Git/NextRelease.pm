...
so that the timestamps produced are generated by asking C<git> for the timestamp of the current branch.

If you always require a specific branch for generating timestamps, it can be specified as a parameter.
